...
class MyTopo( Topo ):
    ...
    def build( self ):
        ...
        self.addLink( Switch2, Switch4, cls=TCLink, bw=5 )
        self.addLink( Switch3, Switch5, cls=TCLink, bw=5 )
        self.addLink( Switch2, Switch5, cls=TCLink, bw=5 )
        self.addLink( Switch3, Switch4, cls=TCLink, bw=5 )
